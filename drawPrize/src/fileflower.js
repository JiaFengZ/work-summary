    ...
    function loop() {
        ...
        var color = ctx.createLinearGradient(cw / 2 - textData.width / 2,0,cw ,100);
        color.addColorStop(1,"#f52222");
        color.addColorStop(0,"#f52222");
        ctx.fillStyle = color;//"rgba(255,0,0," + Math.random() + ")";
        ctx.fillText(text, cw / 2 - textData.width / 2, 35);
